...
{
    public abstract class InnerNetworkRecvPacket : IRecvPacket
    {
        public BinaryReader Reader;
        public InnerNetworkClient Client;

        public void Process(InnerNetworkClient client)
        {
            Client = client;

            using (Reader = new BinaryReader(new MemoryStream(Client.Buffer)))
            {
                Read();
            }
